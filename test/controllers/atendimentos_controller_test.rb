...
class AtendimentosControllerTest < ActionController::TestCase
  ...
  test "should create atendimento" do
    assert_difference('Atendimento.count') do
      post :create, atendimento: { area: @atendimento.area, categoria: @atendimento.categoria, data: @atendimento.data, detalhes: @atendimento.detalhes }
    end
  ...
  test "should update atendimento" do
    patch :update, id: @atendimento, atendimento: { area: @atendimento.area, categoria: @atendimento.categoria, data: @atendimento.data, detalhes: @atendimento.detalhes }
    assert_redirected_to atendimento_path(assigns(:atendimento))
  end
